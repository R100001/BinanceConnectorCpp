...
#ifndef MARKET_DATA_PARSING_SIMDJSON_HPP
#define MARKET_DATA_PARSING_SIMDJSON_HPP
...
template <typename simdjson_value>
auto tag_invoke(deserialize_tag, simdjson_value &val, MarketData::RateLimit &rate_limit) {
...
template <typename simdjson_value>
auto tag_invoke(deserialize_tag, simdjson_value &val, MarketData::Asset &asset) {
...
#endif // MARKET_DATA_PARSING_SIMDJSON_HPP
